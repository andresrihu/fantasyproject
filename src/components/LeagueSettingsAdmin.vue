<template>
    ...
    <div class="container w-100 p-3 h600"> 
        ...
        <form action="/route" method = "POST">
            ...
            <div class="form-group">
                <input v-model="twoptconvptsdspts" class="form-control" type="text">
            </div>
            ...
            <div class="form-group">
                <input v-model="fieldgoals019pts" class="form-control" type="text">
            </div>
            <label class="label">Field Goals 20-29 Points</label>
            <div class="form-group">
                <input v-model="fieldgoals2029pts" class="form-control" type="text">
            </div>
            <label class="label">Field Goals 30-39 Points</label>
            <div class="form-group">
                <input v-model="fieldgoals3039pts" class="form-control" type="text">
            </div>
            <label class="label">Field Goals 40-49 Points</label>
            <div class="form-group">
                <input v-model="fieldgoals4049pts" class="form-control" type="text">
            </div>
           <label class="label">Field Goals 50+ Points</label>
            <div class="form-group">
                <input v-model="fieldgoals50pluspts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 0 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed0pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 1-6 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed16pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 7-13 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed713pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 14-20 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed1420pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 21-27 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed2127pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 28-34 Points</label>
            <div class="form-group">
                <input v-model="pointsallowed2834pts" class="form-control" type="text">
            </div>
           <label class="label">Points Allowed 35+ Points</label>
            <div class="form-group">
                <input v-model="pointsallowed35pluspts" class="form-control" type="text">
            </div>
           ...
           <label class="label">Interception Points</label>
            <div class="form-group">
                <input v-model="pdefinterceptionpts" class="form-control" type="text">
            </div>
           ...
           <label class="label">Special Teams TDs Points</label>
            <div class="form-group">
                <input v-model="Special Teams TDs Points" class="form-control" type="text">
            </div>
           <label class="label">Extra Point Return Points</label>
            <div class="form-group">
                <input v-model="extraptsretpts" class="form-control" type="text">
            </div>
            <button class="btn btn-primary btn-color btn-bg-color btn-sm col-xs-2 margin-left" type=submit>Submit</button> 
        </form>
            </div>
        </div>
    </div>
...
pointsallowed16pts: "",
pointsallowed713pts: "",
pointsallowed1420pts: "",
pointsallowed2127pts: "",
pointsallowed2834pts: "",
pointsallowed35pluspts: "",
sackspts: "",
pdefinterceptionpts: "",
fumblerecovpts: "",
deftdpts: "",
